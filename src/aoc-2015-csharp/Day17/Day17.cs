namespace aoc_2015_csharp.Day17;
...
public static class Day17
{
    ...
    {
        var containers = File.ReadAllLines("Day17/day17.txt")
            .OrderBy(int.Parse)
    ...
    private static List<List<Container>> GetCombinations(List<Container> containers, int length)
    {
        ...
        return GetCombinations(containers, length - 1)
            .SelectMany(
                x => containers.Where(y => String.Compare(y.Name, x.Last().Name, StringComparison.Ordinal) > 0),
